...
<x-guest-layout>
    ...
    <div class="flex h-screen lg:h-[calc(100vh-100px)]">
        ...
        <div class="w-full bg-gray-200 lg:w-[30%] flex items-center justify-center">
            <div class="max-w-md w-full p-6 text-gray-600  ">
                ...
                <h1 class="text-sm font-semibold mb-6  text-center">Join to Our Community with all time
                    access and free </h1>

                <form action="#" method="POST" class="space-y-4 text-gray-700 dark:text-gray-200">
                ...
                <div class="mt-4 text-sm  text-center">
                    <p>Already have an account? <a href="#" class=" font-bold hover:underline">Login
                            here</a>
                    </p>
                </div>
            </div>
    ...
    {{-- FOOTER --}}
    <footer class="bg-gray-200/50 font-sans dark:bg-gray-900">
        <div class="container px-6 py-12 mx-auto">
            <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 sm:gap-y-10 lg:grid-cols-4">
                <div class="sm:col-span-2">
                    <h1
                        class="max-w-lg text-xl font-semibold tracking-tight text-gray-500 xl:text-2xl dark:text-white">
                ...
                <div>
                    ...
                    <div class="flex flex-col items-start mt-5 space-y-2">
                        <p
                            class="text-gray-500 transition-colors duration-300 dark:text-gray-300 dark:hover:text-blue-400 hover:underline hover:cursor-pointer hover:text-blue-500">
                            Home</p>
                        <p
                            class="text-gray-500 transition-colors duration-300 dark:text-gray-300 dark:hover:text-blue-400 hover:underline hover:cursor-pointer hover:text-blue-500">
                            Who We Are</p>
                ...
                <div>
                    <p class="font-semibold text-gray-600 dark:text-white">Industries</p>
