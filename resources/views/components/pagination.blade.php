                            ...
                            @foreach ($element as $page => $url)
                                @if ($page == $paginator->currentPage())
                                    <span aria-current="page">
                                        <span
                                            class="relative inline-flex items-center px-4 py-2 -ml-px text-sm font-medium text-white-500 bg-white border border-white-300 cursor-default leading-5 dark:bg-indigo-800 dark:border-indigo-600">{{ $page }}</span>
                                    </span>
                                @else
                                    <a href="{{ $url }}"
