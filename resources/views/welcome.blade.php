        ...
        <div>
            <section>
                <x-container>
                    ...
                    <div x-data="data" class ="md:flex gap-6">
                        <!-- Overlay oscuro (solo en móvil cuando open=true) -->
                        <div x-show="open" @click="open = false; scrollLock()" x-cloak
                        ...
                        <aside :class="open ? 'translate-x-0' : '-translate-x-full lg:translate-x-0'" x-cloak
                            class="fixed z-40 top-0 left-0 h-full bg-white w-80 border-r overflow-auto transition-transform duration-300 ease-in-out {{-- lg:sticky lg:top-5 --}} lg:relative lg:translate-x-0">
                            <form action="{{ route('home') }}" class="overflow-auto h-full">
                                <header class="relative h-16 lg:hidden border-b-2 border-gray-300">
                                    <div
                                        class="w-full absolute top-0 flex justify-between items-center lg:hidden my-4 px-4">
                                        <h2 class="text-lg font-semibold">Filtros</h2>
                                        <button @click="open = false; scrollLock()"
                                            class="text-gray-600 hover:text-black">&times;</button>
                                    </div>
                                </header>
                                <div class="h-[calc(100%-100px)] overflow-y-auto px-4 py-4">
                                    <div class="mb-4">
                                        <label for="order"
                                ...
                                <div
                                    class="flex justify-center items-center w-full border-t-2 lg:border-0 border-gray-300 bg-white h-16 lg:h-auto fixed bottom-0 lg:relative lg:pb-4">
                        ...
                        <div class="w-full">
                            ...
                            <div class="lg:hidden mb-4">
                                <button @click="open = true; scrollLock()"
